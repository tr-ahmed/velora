  ...
  return (
    ...
    >
      ...
      <div className="sm:hidden relative min-h-[100svh] flex flex-col">
        ...
        {/* Top Header Logo Bar — Enlarge & Position slightly lower */}
        <div className="relative z-20 flex items-center justify-center text-center px-5 pt-5 pb-1 mt-1 sm:mt-2"
             style={{ paddingTop: 'max(20px, env(safe-area-inset-top, 20px))' }}>
          <div className="flex items-center justify-center mx-auto animate-fadeIn">
            <VeloraLogo size="xl" glow={true} className="scale-125 sm:scale-150 drop-shadow-[0_6px_25px_rgba(197,160,89,0.6)]" />
          </div>
        </div>

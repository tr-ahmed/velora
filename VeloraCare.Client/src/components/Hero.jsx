...
const DEFAULT_SLIDES = [
  {
    ...
    badgeEn: 'The #1 Royal Organic Care Store 👑',
    titleHighlight: 'إكسير النضارة',
    titleHighlightEn: 'Emerald',
    titleRest: 'الزمردية',
    titleRestEn: 'Glow Elixir',
    description: 'اكتشفي تشكيلة VELORA CARE المستخلصة من أنقى العناصر النباتية وزيوت الزمرد العضوية.',
    descriptionEn: 'Discover VELORA CARE collection, extracted from the purest botanical elements and organic emerald oils.',
    productImage: '/images/serum.png',
    productTitle: 'سيروم الزمرد لإحياء الشباب',
    productTitleEn: 'Emerald Youth Serum',
    productSub: 'إكسير نباتي مكثف',
    productSubEn: 'Intensive Botanical Elixir',
    rating: '4.9',
  ...
  },
  {
    ...
    badgeEn: 'Royal Velvet Hydration 🧴',
    titleHighlight: 'حماية وتنعيم',
    titleHighlightEn: 'Protect & Soften',
    titleRest: 'يدوم 72 ساعة',
    titleRestEn: 'Lasts 72 Hours',
    description: 'كريم فاخر غني بزبدة الشيا العضوية والسيراميد النباتي لإصلاح حاجز البشرة.',
    descriptionEn: 'Luxurious cream rich in organic shea butter and plant ceramides to repair the skin barrier.',
    productImage: '/images/cream.png',
    productTitle: 'كريم الترطيب الزمردي',
    productTitleEn: 'Emerald Hydrating Cream',
    productSub: 'ترطيب عميق بالسيراميد',
    productSubEn: 'Deep Ceramide Hydration',
    rating: '4.8',
  ...
  },
  {
    ...
    titleRestEn: '& Royal Radiance',
    description: 'مزيج ساحر من 7 زيوت بكر نادرة محقونة برقائق الذهب العضوي النقي.',
    descriptionEn: 'A magical blend of 7 rare virgin oils infused with pure organic gold flakes.',
    productImage: '/images/glow_oil.png',
    productTitle: 'زيت فيلورا الذهبي',
    productTitleEn: 'Velora Golden Oil',
    productSub: 'تغذية بالذهب والنباتات',
    productSubEn: 'Gold & Plant Nourishment',
    rating: '5.0',

...
export default function Header({ 
  ...
  return (
    <>
      ...
      {/* --- MOBILE MINIMAL HEADER & TOGGLE --- */}
      <div className="sm:hidden fixed top-0 left-0 right-0 z-[60] print:hidden pointer-events-none p-3 sm:p-4 flex justify-between items-start">
        
        {/* Brand Logo (Clickable) */}
        <div 
          onClick={() => { setActiveTab('home'); setIsFloatingMenuOpen(false); }}
          className="pointer-events-auto bg-[#0D221A]/80 backdrop-blur-md rounded-2xl px-3 py-1.5 border border-[#C5A059]/40 shadow-lg"
        >
        ...
        <div className="relative pointer-events-auto">
          ...
          {/* Floating Panel */}
          <div className={`absolute top-14 ${isEn ? 'right-0 origin-top-right' : 'left-0 rtl:left-auto rtl:right-0 origin-top-left rtl:origin-top-right'} w-[calc(100vw-32px)] max-w-sm transition-all duration-300 ${
            isFloatingMenuOpen 

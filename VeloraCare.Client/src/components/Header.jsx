            ...
            <div className="flex items-center gap-3 sm:gap-4">
              ...
              <div className="flex items-center gap-1 sm:gap-2">
                ...
                <button
                  ...
                  className="hidden lg:flex items-center gap-1 p-1.5 text-gray-300 hover:text-[#EAD096] transition-colors"
              ...
              <div className="relative flex items-center justify-end w-8 focus-within:w-36 sm:focus-within:w-48 xl:focus-within:w-64 transition-all duration-300 ease-out z-50">

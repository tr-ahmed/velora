...
const channels = [
  ...
  {
    name: 'TikTok',
    url: 'https://www.tiktok.com/@velora.care7?_r=1&_t=ZS-98PJL7tSMDc',
    color: 'bg-black border border-[#C5A059]/40',
    icon: (
      <svg viewBox="0 0 24 24" className="w-5 h-5 fill-current">
  ...
  {
    name: 'Instagram',
    url: 'https://www.instagram.com/care_velora?utm_source=qr&igsh=czhheGFxbnZsYnFy',
  ...
  {
    name: 'Facebook',
    url: 'https://www.facebook.com/share/1DGKUiYnqH/',
    color: 'bg-[#1877F2]',
    icon: (
      <svg viewBox="0 0 24 24" className="w-5 h-5 fill-current">
